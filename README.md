...
bash
git clone 
cd oss-audit--24BCY10167
3. Make All Scripts Executable
bash
chmod +x *.sh
4. Run Script 1 - System Identity Report
bash
...
5. Run Script 2 - FOSS Package Inspector
bash
...
6. Run Script 3 - Disk and Permission Auditor
bash
...
7. Run Script 4 - Log File Analyzer
bash
